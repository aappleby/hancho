...
class TestTasks(unittest.TestCase):
    ...
    def test_run_tasks_zero(self):
        ...
        self.run_tasks(0)
        self.assertIsNone(good_task._error2)
    ...
    def test_run_tasks_nonzero(self):
        ...
        self.run_tasks(-1)
        self.assertIsInstance(bad_task._error2, hancho.Task.FAILED) #type:ignore
...
#        self.assertTrue(Path("subrepo_tests/build/repo2/repo2.txt").exists())
    ...
    def test_bad_build_path(self):
        ...
        self.run_tasks(-1)
        self.assertIsInstance(bad_task._error2, hancho.Task.BROKEN)
    ...
    def test_bad_run_cmd(self):
        ...
        self.run_tasks(-1)
        self.assertIsInstance(task._error2, hancho.Task.BROKEN)
    ...
    def test_garbage_command(self):
        ...
        self.run_tasks(-1)
        self.assertIsInstance(garbage_task._error2, hancho.Task.FAILED)
    ...
    def test_task_collision(self):
        ...
        self.run_tasks(-1)
        self.assertIsInstance(task2._error2, hancho.Task.BROKEN)
    ...
    def test_cancellation(self):
        ...
        self.assertIsInstance(task_that_fails._error2, hancho.Task.FAILED)
        self.assertIsNone(task_that_passes._error2)
        self.assertIsInstance(should_be_cancelled._error2, hancho.Task.CANCELLED)
